...
from ...utils import box_utils, calibration_kitti, common_utils, object3d_kitti, vod_utils
...
class VODNDataset(DatasetTemplate):
    ...
    def get_image(self, idx):
        ...
        """
        img_file = self.root_split_path / 'noise_img' /'rho_0.50'/ ('%s.jpg' % idx)
...
def create_kitti_infos(dataset_cfg, class_names, data_path, save_path, workers=4):
    ...
    train_filename = save_path / ('kitti_infos_noise_%s.pkl' % train_split)
    val_filename = save_path / ('kitti_infos_noise_%s.pkl' % val_split)
    trainval_filename = save_path / 'kitti_infos_noise_trainval.pkl'
    test_filename = save_path / 'kitti_infos_noise_test.pkl'
...
if __name__ == '__main__':
    ...
    if sys.argv.__len__() > 1 and sys.argv[1] == 'create_kitti_infos':
        ...
        create_kitti_infos(
            ...
            data_path=ROOT_DIR / 'data' / 'vod_radar_5frames',
            save_path=ROOT_DIR / 'data' / 'vod_radar_5frames'
        )
